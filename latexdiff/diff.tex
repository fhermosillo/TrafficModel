...
%DIF DEL D:\CINVESTAV\Doctorado\Cuatrimestre\7\Dr Deni\TrafficModel/tmp.old.tex                 Fri Oct  2 02:26:01 2020
...
\DIFdelbeginFL \DIFdelFL{$\boldsymbol{\otimes}_{outer}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\boldsymbol{\otimes}$ }\DIFaddendFL & Outer product of two vectors.\\
...
\DIFdelbeginFL \DIFdelFL{$rank_{t}(\mathten{X})$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$rank_{D}(\mathten{X})=R$ }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Decomposition}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Tensor decomposition}\DIFaddendFL /CP rank.\\
\DIFdelbeginFL \DIFdelFL{$rank_{tc}(\mathten{X})$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$rank_{tc}(\mathten{X})=(R_1,\cdots, R_N)$ }\DIFaddendFL & \DIFdelbeginFL \DIFdelFL{Multilinear}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Tensor multilinear}\DIFaddendFL /Tucker rank\DIFaddbeginFL \DIFaddFL{, where $R_n = rank(\mathmat{X}_{(n)})$}\DIFaddendFL .\\
\DIFaddbeginFL \DIFaddFL{$rank_k(\mathten{X})$ }& \DIFaddFL{Tensor Kruskal-rank}\\
\DIFaddendFL \textemdash\textemdash	 & \textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\\
...
\textemdash\textemdash	 & \textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\textemdash\\
\DIFdelbeginFL \DIFdelFL{$\mathten{V}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\mathten{V}_\tau$ }\DIFaddendFL & Video of duration $\tau$, represented as a tensor.\\
$\mathten{B}$ & Background tensor.\\
$\mathten{F}$ & Foreground tensor.\\
\DIFdelbeginFL \DIFdelFL{$\mathten{Z}$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$\mathten{T}$ }\DIFaddendFL & Vehicle traffic features tensor.\\
\bottomrule
\end{tabular}
\end{table}
\DIFaddbegin 
